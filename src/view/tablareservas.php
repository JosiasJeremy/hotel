...
<div class="grid grid-cols-3 gap-6 my-6 text-center">
    ...
    <div class="bg-yellow-600 p-4 rounded-lg shadow-lg border border-gray-300 h-64 flex flex-col justify-between">
        ...
        <a href="#" onclick="openModal()" class="block bg-green-500 text-white py-2 px-4 text-center rounded-lg hover:bg-green-600 mt-4">DATOS</a>
    ...
    <!-- Incluir Modal -->
    <?php include '../components/modalReserva.php'; ?>
